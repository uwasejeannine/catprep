...
console.log(farm.addFarm(756, "Gashora Firm", "Karisa", 78989737, "Gashora"));
let fr = new Mkulima();
console.log(fr.addFarm(416, "Kirehe Farm", "Kamari", +25078990837, "Kirehe"));

console.log(farm.removeFarm(756));
console.log(farm.updateFarm(23453, "Kinamba Farm", "Gad", "+3453436336", "Kitale"));
console.log(farm.getFarm(416));
console.log(farm.addProduct(756, "Akandi", 67000));
console.log(farm.updateProduct("567CD", "maize", 6800));
console.log("calculateOrderCost:" + "" + farm.getProduct(5674));
console.log(farm.printProducts("Mango", 400, "Orange", 600, "Banana", 300));
console.log(farm.calculateOrderCost(456, 12))